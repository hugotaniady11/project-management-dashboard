...
import  resources  from '../../utils/data/resources.json'
            ...
            <div class="inline-block min-w-full align-middle">
                <div class="overflow-hidden shadow">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed ">
                        ...
                        <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap "> {resources.resource_id} </td>
                        <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap ">{resources.resource_name} </td>
                        <td className="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs ">{resources.resource_type} </td>
                        <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap ">{resources.quantity} </td>
