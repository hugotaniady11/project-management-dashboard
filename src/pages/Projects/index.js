                                    ...
                                    {records.map((data) => (
                                        <tr className="hover:bg-gray-100 ">
                                            ...
                                            <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                                <div class="flex items-center">
                                                    {data.status === "Done" ? (
                                                        <><div class="h-2.5 w-2.5 rounded-full bg-green-400 mr-2"></div><p className='text-gray-500'>{data.status}</p></>
                                                    ) : data.status === "Pending" ? (
                                                        <><div class="h-2.5 w-2.5 rounded-full bg-red-500 mr-2"></div><p className='text-gray-500'>{data.status}</p></>
                                                    ) : (
                                                        <><div class="h-2.5 w-2.5 rounded-full bg-yellow-500 mr-2"></div><p className='text-gray-500'>{data.status}</p></>
                                                    )}
                                                </div>
                                            </td>
