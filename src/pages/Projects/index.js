            ...
            <div class="p-8 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 ">
                <div class="w-full mb-1">
                    <div class="mb-4">
                            ...
                            <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="#" class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 ">Projects</a>
                                    </div>
                                </li>
                                <li>
                                    <div class="flex items-center">
                        ...
                        <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl ">All Projects</h1>
                    </div>
                    <div class="sm:flex">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200 ">
                                    {projects.map((project) => (
                                        <tr className="hover:bg-gray-100 ">
                                            <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap ">{project.project_id}</td>
                                            <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap "> {project.name} </td>
                                            <td className="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs "> {project.description} </td>
                                            <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                                <div class="flex items-center">
                                                    {project.status === "Done" ? (
                                                        <><div class="h-2.5 w-2.5 rounded-full bg-green-400 mr-2"></div><p className='text-gray-500'>{project.status}</p></>
                                                    ) : project.status === "Pending" ? (
                                                        <><div class="h-2.5 w-2.5 rounded-full bg-red-500 mr-2"></div><p className='text-gray-500'>{project.status}</p></>
                                                    ) : (
                                                        <><div class="h-2.5 w-2.5 rounded-full bg-yellow-500 mr-2"></div><p className='text-gray-500'>{project.status}</p></>
                                                    )}
                                                </div>
                                            </td>
