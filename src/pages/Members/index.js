            ...
            <div class="overflow-hidden shadow">
                <table class="min-w-full divide-y divide-gray-200 table-fixed ">
                    ...
                    {users.map((user) => (
                       ...
                       <td className="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs "> {user.biography} </td>
                       <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap "> {user.position} </td>
                       <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap "> {user.country} </td>
                       <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="flex items-center">
                                    {user.status === "Active" ? (
                                      <><div class="h-2.5 w-2.5 rounded-full bg-green-400 mr-2"></div><p className='text-gray-500'>{user.status}</p></>
                                    ) : (
                                      <><div class="h-2.5 w-2.5 rounded-full bg-red-500 mr-2"></div><p className='text-gray-500'>{user.status}</p></>
                                    )}
                                </div>
                            </td>
