...
import  analytics  from '../../utils/data/analytics.json'
    ...
    <>
      ...
      <div class="w-full mb-1">
          <div class="mb-4">
                  ...
                  <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                    ...
                    <li>
                      <div class="flex items-center">
                        ...
                        <a href="#" class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 ">analytics</a>
                      </div>
                    </li>
                    <li>
                      <div class="flex items-center">
              ...
              <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl ">Analytics page</h1>
          </div>
          <div class="sm:flex">
              <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 ">
                  ...
                  <div class="relative mt-1 lg:w-64 xl:w-96">
                      <input type="text" name="email" id="users-search" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" placeholder="Search for analytics" />
                  </div>
                  </form>
              </div>
          </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed ">
                        ...
                        <td className="w-4 p-4">
                            <div className="flex items-center">
                                <input id="checkbox-{{ user.id }}" aria-describedby="checkbox-1" type="checkbox" class="w-4 h-4 border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 "/>
                                <label for="checkbox-{{ user.id }}" className="sr-only">checkbox</label>
                            </div>
                        </td>
                        <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap "> {analytics.project_id} </td>
                        <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap ">$ {analytics.budget} </td>
                        <td className="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs ">$ {analytics.revenue} </td>
                        <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap ">$ {analytics.profit_margin} </td>
                        <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="flex items-center">
                                    {analytics.project_status === "Done" ? (
                                      <><div class="h-2.5 w-2.5 rounded-full bg-green-400 mr-2"></div><p className='text-gray-500'>{analytics.project_status}</p></>
                                    ) : analytics.project_status === "Pending" ? (
                                      <><div class="h-2.5 w-2.5 rounded-full bg-red-500 mr-2"></div><p className='text-gray-500'>{analytics.project_status}</p></>
                                    ) : (
                                      <><div class="h-2.5 w-2.5 rounded-full bg-yellow-500 mr-2"></div><p className='text-gray-500'>{analytics.project_status}</p></>
                                    )}
                                </div>
                            </td>
